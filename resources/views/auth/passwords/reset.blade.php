                    ...
                    <form method="POST" action="{{ route('password.update') }}">
                        ...
                        <div class="ui search focus mt-50">
                            <div class="ui left icon input swdh95">
                                <input class="prompt srch_explore" name="email" value="{{ $email ?? old('email') }}" type="email" id="id_email" required="" maxlength="64" placeholder="Email Address" readonly>
                        ...
                        <div class="ui search focus mt-50">
                            <div class="ui left icon input swdh95">
                                <input class="prompt srch_explore" name="password_confirmation" type="password" value="" id="password_confirmation" required=""  placeholder="Confirm Password">
                                <i class="uil uil-lock icon icon2"></i>
                            </div>
                        </div>
