<footer class="footer mt-40 " style="text-align: center;">
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12" style="padding-top:20px; padding-bottom:15px; ">
                <p style="color:white">© {{ date('Y') }} <strong>{{ config('app.name') }}</strong>. All Rights Reserved.</p>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-12">
                <a style="color:white" href="{{ route('about') }}">About</a>
            </div>
            <div class="col-lg-12">
                <a style="color:white" href="{{ route('contact') }}">Contact</a>
            </div>
            <div class="col-lg-12">
                <a style="color:white" href="{{ route('terms') }}">Terms of use</a>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-12">
